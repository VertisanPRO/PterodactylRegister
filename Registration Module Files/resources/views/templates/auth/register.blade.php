...
@endif
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <p class="cyh04c-7 fFcOT">© 2015 - {new Date().getFullYear()}&nbsp;<a rel="noopener nofollow noreferrer" href="https://pterodactyl.io" target="_blank" class="cyh04c-8 emCXNB">Pterodactyl Software</a></p>
        </div>
      </div>
    </div>
  </div>
